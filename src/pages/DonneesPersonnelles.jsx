...
const DonneesPersonnelles = () => {
  return (
    <div className="donnees-personnelles">
      ...
      <p>
        ...
        visite le Site objet des présentes conditions générales. <br></br>
        <b>Prestations et Services :</b>{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> met à disposition des
        Clients :
      </p>
      <p>
      ...
      <p>
        ...
        détenues par <a href="https://raphds.fr">https://raphds.fr</a> pour la
      ...
      <p>
        ...
        site internet <a href="https://raphds.fr">https://raphds.fr</a>{" "}
      ...
      <p>
        L’utilisation du site <a href="https://raphds.fr">https://raphds.fr</a>{" "}
        ...
        utilisateurs du site <a href="https://raphds.fr">https://raphds.fr</a>{" "}
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a>, qui s’efforcera alors
        de communiquer préalablement aux utilisateurs les dates et heures de
        l’intervention. Le site web{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> est mis à jour
        régulièrement par <a href="https://raphds.fr">https://raphds.fr</a>{" "}
      ...
      <p>
        Le site internet <a href="https://raphds.fr">https://raphds.fr</a> a
        pour objet de fournir une information concernant l’ensemble des
        activités de la société.
        <a href="https://raphds.fr">https://raphds.fr</a> s’efforce de fournir
        sur le site <a href="https://raphds.fr">https://raphds.fr</a> des
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> sont données à titre
        indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
        renseignements figurant sur le site{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> ne sont pas
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> est hébergé chez un
      ...
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> et l’hébergeur ne
      ...
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> est propriétaire des
        ...
        <a href="https://raphds.fr">https://raphds.fr</a>.
      </p>
      <p>
      ...
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> agit en tant
        qu’éditeur du site. <a href="https://raphds.fr">https://raphds.fr</a>{" "}
        est responsable de la qualité et de la véracité du Contenu qu’il publie.{" "}
      </p>
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> ne pourra être tenu
        responsable des dommages directs et indirects causés au matériel de
        l’utilisateur, lors de l’accès au site internet{" "}
        <a href="https://raphds.fr">https://raphds.fr</a>, et résultant soit de
      ...
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> ne pourra également
        ...
        site <a href="https://raphds.fr">https://raphds.fr</a>. Des espaces
        interactifs (possibilité de poser des questions dans l’espace contact)
        sont à la disposition des utilisateurs.{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> se réserve le droit de
        ...
        cas échéant, <a href="https://raphds.fr">https://raphds.fr</a> se
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Da Silva
        Raphaël. <a href="https://raphds.fr">https://raphds.fr</a>est représenté
        par Da Silva Raphaël, son représentant légal
      </p>
      <p>
        En tant que responsable du traitement des données qu’il collecte,{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> s’engage à respecter
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> traite des Données
        Personnelles, <a href="https://raphds.fr">https://raphds.fr</a> prend
        ...
        lesquelles <a href="https://raphds.fr">https://raphds.fr</a> les traite.
      </p>
      <h3>7.2 Finalité des données collectées</h3>
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> est susceptible de
      ...
      <ul>
        ...
        <li>
          ...
          <a href="https://raphds.fr">https://raphds.fr</a> : adresse email{" "}
        </li>
        <li>
      ...
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> ne commercialise pas
      ...
      <p>
        ...
        de <a href="https://raphds.fr">https://raphds.fr</a> disposent des
        droits suivants :{" "}
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          et de choisir à qui <a href="https://raphds.fr">https://raphds.fr</a>{" "}
          devra communiquer (ou non) ses données à un tiers qu’ils aura
          préalablement désigné
        </li>
      </ul>
      <p>
        Dès que <a href="https://raphds.fr">https://raphds.fr</a> a connaissance
        du décès d’un Utilisateur et à défaut d’instructions de sa part,{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> s’engage à détruire
        ses données, sauf si leur conservation s’avère nécessaire à des fins
        probatoires ou pour répondre à une obligation légale.
      </p>
      <p>
        Si l’Utilisateur souhaite savoir comment{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> utilise ses Données
        Personnelles, demander à les rectifier ou s’oppose à leur traitement,
        l’Utilisateur peut contacter{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> par écrit à l’adresse
        suivante :{" "}
      </p>
      Da Silva Raphaël – DPO, Da Silva Raphaël <br></br>
      rue jean monnet 76240 Le Mesnil Esnard.
      <p>
        Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il
        souhaiterait que <a href="https://raphds.fr">https://raphds.fr</a>{" "}
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> par la loi, notamment
        en matière de conservation ou d’archivage des documents. Enfin, les
        Utilisateurs de <a href="https://raphds.fr">https://raphds.fr</a>{" "}
        peuvent déposer une réclamation auprès des autorités de contrôle, et
        notamment de la CNIL (https://www.cnil.fr/fr/plaintes).
      </p>
      <h3>7.4 Non-communication des données personnelles</h3>
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> s’interdit de traiter,
        héberger ou transférer les Informations collectées sur ses Clients vers
        un pays situé en dehors de l’Union européenne ou reconnu comme « non
        adéquat » par la Commission européenne sans en informer préalablement le
        client. Pour autant, <a href="https://raphds.fr">https://raphds.fr</a>{" "}
      ...
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> s’engage à prendre
        ...
        à la connaissance de <a href="https://raphds.fr">https://raphds.fr</a>,
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> ne collecte aucune «
        données sensibles ».
      </p>
      <p>
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de <a href="https://raphds.fr">https://raphds.fr</a> et des
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> sont principalement
        les agents de notre service client.
      </p>
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> n'est publiée à l'insu
        de l'utilisateur, échangée, transférée, cédée ou vendue sur un support
        quelconque à des tiers. Seule l'hypothèse du rachat de{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> et de ses droits
        ...
        du site <a href="https://raphds.fr">https://raphds.fr</a>.
      </p>
      <h3>Sécurité</h3>
      <p>
        Pour assurer la sécurité et la confidentialité des Données Personnelles
        et des Données Personnelles de Santé,{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> utilise des réseaux
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a>prend toutes les
      ...
      <p>
        Le site <a href="https://raphds.fr">https://raphds.fr</a> contient un
        certain nombre de liens hypertextes vers d’autres sites.Cependant,{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> n’a pas la possibilité
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> d’améliorer le contenu
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> informe l’Utilisateur
        que, dans ce cas, il se peut que les fonctionnalités de son logiciel de
      ...
      <p>
        ...
        être le cas lorsque <a href="https://raphds.fr">https://raphds.fr</a> ou
      ...
      <p>
        Le cas échéant, <a href="https://raphds.fr">https://raphds.fr</a>{" "}
        ...
        par <a href="https://raphds.fr">https://raphds.fr</a>, résultant (i) du
        refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> d’enregistrer ou de
        consulter les Cookies nécessaires à leur fonctionnement du fait du choix
        de l’Utilisateur. Pour la gestion des Cookies et des choix de
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> pourra en outre faire
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> ou dans son
        ...
        de <a href="https://raphds.fr">https://raphds.fr</a>, Twitter, Facebook,
        Linkedin et Google Plus peuvent également déposer des cookies sur vos
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a>. À tout moment,
        l’Utilisateur peut néanmoins revenir sur son consentement à ce que{" "}
        <a href="https://raphds.fr">https://raphds.fr</a> dépose ce type de
        cookies.
      </p>
      <h3>Article 9.2. BALISES (“TAGS”) INTERNET</h3>
      <p>
        <a href="https://raphds.fr">https://raphds.fr</a> peut employer
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> d’évaluer les réponses
        des visiteurs face au Site et l’efficacité de ses actions (par exemple,
        le nombre de fois où une page est ouverte et les informations
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a>, et fournir d’autres
      ...
      <p>
        ...
        <a href="https://raphds.fr">https://raphds.fr</a> est soumis au droit
        français. En dehors des cas où la loi ne le permet pas, il est fait
        attribution exclusive de juridiction aux tribunaux compétents de Rouen
      </p>
    </div>
  );
};
