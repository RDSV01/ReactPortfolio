  ...
  return (
    ...
    <div className="innerdiv">
      <div className="div1 eachdiv">
        <div className="userdetails">
          ...
          <div className="detbox">
            <p className="name">Laurent Michon</p>
            <p className="designation">Responsable Marketing / 3D Dental Store</p>
          </div>
        </div>
      ...
      <div className="div2 eachdiv">
        ...
        <div className="review">
        <p>“Rapide, efficace, poli, n'hésitez pas à confier vos missions à Raphaël ! ”</p>
        </div>
      </div>
      <div className="div5 eachdiv">
        <div className="userdetails">
          ...
          <div className="detbox">
            <p className="name">Sophie Drazic Jourdan</p>
